  ...
  return (
    <div>
      ...
      >
        ...
        <div 
          className="absolute bottom-8 left-8 bg-white/90 backdrop-blur-sm px-8 py-6 rounded-3xl shadow-xl"
          style={{ zIndex: 10 }}
        >
          <div className="flex items-center gap-8">
            <span className="text-lg text-gray-700 font-semibold whitespace-nowrap">Partners:</span>
            <div className="flex items-center gap-6">
              ...
              <img 
                ...
                alt="Genk Logo"
                className="h-24 w-auto object-contain opacity-85 hover:opacity-100 transition-opacity duration-200"
              />
              {/* RC Genk Logo */}
              <img 
