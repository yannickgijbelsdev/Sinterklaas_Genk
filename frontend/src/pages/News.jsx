...
export default function News() {
  ...
  // Function to replace all HTML5 audio elements
  const replaceAllAudioElements = () => {
    // Find all divs that contain audio with filenames
    const allDivs = document.querySelectorAll('div');
    allDivs.forEach(div => {
      if (div.innerHTML.includes('🎵') && div.innerHTML.includes('.mp3') && div.querySelector('audio')) {
