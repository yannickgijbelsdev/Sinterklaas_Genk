            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 
                  ...
                  data-editable-text="story_title"
                  data-section="about"
                  data-key="story_title"
                >
                  {storyTitle}
                </h2>
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p
                    data-editable-text="story_content1"
                    data-section="about"
                    data-key="story_content1"
                  >
                    {storyContent1}
                  </p>
                  <p
                    data-editable-text="story_content2"
                    data-section="about"
                    data-key="story_content2"
                  >
                    {storyContent2}
                  </p>
                  <p
                    data-editable-text="story_content3"
                    data-section="about"
                    data-key="story_content3"
                  >
                    {storyContent3}
                  </p>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 
                ...
                data-editable-text="details_title"
                data-section="about"
                data-key="details_title"
              >
                {detailsTitle}
              </h2>
              <p 
                className="text-xl text-gray-600"
                data-editable-text="details_subtitle"
                data-section="about"
                data-key="details_subtitle"
              >
                {detailsSubtitle}
              </p>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 
                className="text-4xl font-bold text-gray-900 mb-4"
                data-editable-text="features_title"
                data-section="about"
              ...
              <p 
                className="text-xl text-gray-600"
                data-editable-text="features_subtitle"
                data-section="about"
